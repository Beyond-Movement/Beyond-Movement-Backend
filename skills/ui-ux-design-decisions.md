...
- ​   Generate a unique invitation link and/or invitation code.
- ​   Copy the invitation link or code.
- ​   Send/share the invitation with the athlete.

Invitation Behaviour
- ​ Each invitation is unique and can only be used to create an authorized athlete account.
- ​ The athlete follows the invitation link or enters the invitation code and then completes their own registration.
- ​ During registration, the athlete creates their account using email/password or Google Sign-In and provides the required profile information.
...
- ​ Invitation guidance for new athletes
...
New Athlete Message
- ​ Display: New athlete? You need an invitation from your coach.
...
Access
- ​ The athlete reaches account creation through a valid invitation link or invitation code generated by the Admin.
...
Behaviour
- ​ If the invitation is associated with an email address, the email can be pre-filled.

- ​ The athlete can create their account using either: Email and password or Google Sign-In.

- ​ Google Sign-In does not bypass the invitation requirement.
...
- ​ Invitation received → Create Account / Google Sign-In → Complete Profile → Athlete Home
